                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="dataTables_length" id="dataTables-example_length">
                                    <form action="/admin/barters" method="get">
                                    <label>
                                        ...
                                        <tr class="gradeA odd" role="row">
                                            ...
                                            <td class="center">
                                                <span style="vertical-align: inherit;">
                                                    <span style="vertical-align: inherit;">
                                                        @if($v->status == 0) 退货中
                                                        @elseif($v->status == 1) 收到货物
                                                        @elseif($v->status == 2) 退款
                                                        @elseif($v->status == 3) 完成
                                                        @endif
                                                    </span>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <a href="/admin/returns/{{ $v->id }}" class="btn btn-info">详情</a><br>
                                                <a href="/admin/returns/{{ $v->id }}/edit" class="btn btn-warning">修改</a>
                                            </td>
