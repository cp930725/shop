    ...
    <div class="panel-body row">
        <form role="form" action="/admin/orders/{{ $data->id }}" method="post">
            ...
            <div class="input-group col-xs-6" >
                ...
                <input type="text" class="form-control" name="oid" disabled placeholder="订单编号" value="{{ $data->oid }}">
            </div>
            <br>
            <div class="input-group col-xs-6" >
                <span class="input-group-addon">下单时间&nbsp;&nbsp;&nbsp;</span>
                <input type="text" class="form-control" name="orders_create" disabled placeholder="下单时间" value="{{ $data->created_at }}">
            </div>
            <br>
            <div class="input-group col-xs-6" >
                <span class="input-group-addon">订单总价&nbsp;&nbsp;&nbsp;</span>
                <input type="text" class="form-control" name="sum" disabled placeholder="订单总价" value="{{ $data->sum }}">
            </div>
            <br>
            <div class="input-group col-xs-6" >
