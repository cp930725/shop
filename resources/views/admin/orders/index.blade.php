                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline text-center" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 100px;">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">总价</span></span>
                                                </th>
                                                ...
                                                <th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 400px;">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">收货地址</span></span>
                                                </th>
                                                <th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 150px;">
                                                    <span style="vertical-align: inherit;">
                                                ...
                                                <th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 200px;">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">订单留言</span></span>
                                                </th>
                                                <th style="width: 80px;">
                                                    <span style="vertical-align: inherit;">
                                        ...
                                        @foreach($order as $k=>$v)
                                            <tr class="gradeA odd" role="row">
                                                ...
                                                <td>
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">{{ $v->ordersUserAddr->name }}</span></span>
                                                </td>
                                                
                                                <td class="center">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">{{ $v->ordersUserAddr->phone }}</span></span>
                                                </td>
                                                <td class="center">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">{{ $v->ordersUserAddr->addr }}</span></span>
                                                </td>
                                                <td class="center">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">
                                                ...
                                                <td class="center">
                                                    <span style="vertical-align: inherit;">
                                                        <span style="vertical-align: inherit;">{{ $v->msg }}</span></span>
                                                </td>
                                                <td>
                                                    <a href="/admin/orderinfo/{{ $v->id }}" class="btn btn-info">详情</a><br>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        {{ $order->appends(['paginate' => $num, 'keyword'=>$keyword])->links() }}
                                    </div>
                                </div>
                            </div> 
