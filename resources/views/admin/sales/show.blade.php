...
<div class="panel">
    ...
    <div class="panel-body row">
	    <form role="form" action="/admin/sales" method="post" enctype="multipart/form-data">
	    	{{ csrf_field() }}
	    	<input type="hidden" name="goods_id" value="{{ $goods->id }}">
	  	    <div class="input-group col-xs-5" >
	            <span class="input-group-addon">商品名&nbsp;&nbsp;&nbsp;&nbsp;</span>
	            <input type="text" class="form-control" name="name" placeholder="" value="{{ $goods->name }}" readonly>
	        ...
	        <div class="input-group col-xs-5">
	            ...
	            <input type="text" class="form-control" name="price" placeholder="" value="{{ $goods->price }}" readonly>
	            <span class="input-group-addon">
	        ...
	        <div class="input-group col-xs-5">
	            ...
	            <input type="number" class="form-control" name="discount" placeholder="" value="" max="9.9" min="1" step="0.1">
	            <span class="input-group-addon">
