				...
				<div class="products-category">
						...
						<div class="product-item-container" style="height:420px">
							<div class="left-block">
								<div class="product-image-container lazy second_img ">
									<img data-src="/uploads/goods/{{ $v->pic }}" src="/uploads/goods/{{ $v->pic }}"  alt="Apple Cinema 30&quot;" onerror="this.src='{{ $v->pic }}'" class="img-responsive" style="width:238px; height: 238px" />
									<a href="/home/goodsinfo/{{ $v->id }}"><img data-src="{{ $v->sub_pic }}" src=""  alt="Apple Cinema 30&quot;" onerror="this.src='/uploads/goods/subpic/wt8y5q10aBibCkyVl0wrL4ma77dYrpgsT1cg4yQ2.jpeg'" class="img_0 img-responsive" /></a>
								</div>
								<!--Sale Label-->
					...
					<div class="countdown_inner">
							...
							<div class="right-block">
								<div class="caption">
									<h4 style="height:52px"><a href="/home/goodsinfo/{{ $v->id }}" title="{{ $v->intro }}">{{ $v->title }}&quot;</a></h4>		
									<div class="ratings">
										<div class="rating-box">
											<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
											<span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span>
									...
									<div class="price">
										...
										<div class="pull-right" style="margin-right:15px">
											@if(in_array($v->id, $goodsid))
												...
												<a href="javascript:;" title="添加到我的收藏" class="like" value="{{ $v->id }}" style="display: none;">
									        	<i class="fa fa-heart"></i>
												</a>
												<a href="javascript:;" title="取消收藏" class="dislike" value="{{ $v->id }}">
									        	<i class="fa fa-heart" style="color:#DA2723"></i>
												</a>
											@else
												<span style="font-size: 10px; color:#999">收藏&nbsp;:</span>
												<a href="javascript:;" title="添加到我的收藏" class="like" value="{{ $v->id }}">
									        	<i class="fa fa-heart"></i>
												</a>
												<a href="javascript:;" title="取消收藏" class="dislike" style="display: none" value="{{ $v->id }}">
									        	<i class="fa fa-heart" style="color:#DA2723"></i>
												</a>
											@endif
					...
					<div class="product-filter product-filter-bottom filters-panel" >
						<div class="row">
						   ...
						   <div class="short-by-show text-center col-md-7 col-sm-8 col-xs-12">
							...
							<div class="box-pagination col-md-3 col-sm-4 text-right">{{ $goods->links() }}</div>
